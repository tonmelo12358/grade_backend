...
log_path = "log/"
# Verifica se o diretorio para armazenar os logs que não existem
...
logging.basicConfig(level=logging.DEBUG)  # Configura o logger para registrar mensagens de DEBUG ou superiores
